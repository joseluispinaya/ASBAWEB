<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="ListaPagaduria.aspx.cs" Inherits="CapaPresentacion.ListaPagaduria" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    <div class="card shadow mb-4">
    <div class="card-header bg-second-primary">
        <h6 class="m-0 font-weight-bold text-white">Lista de Pagaduria</h6>
    </div>
    <div class="card-body" id="cargann">
        <div class="row">
            <div class="col-sm-12">
                <table id="tbdatapagaduria" class="table table-sm table-striped" cellspacing="0" style="width: 100%">
                    <thead>
                        <tr>
                            <th>Id</th>
                            <th>Productor</th>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <div class="form-row">
                                <div class="input-group input-group-sm col-sm-4 mb-3">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text" id="inputGroupnomprod">Productor:</span>
                                    </div>
                                    <input type="text" class="form-control text-right" aria-label="Small"
                                ...
                                <div class="input-group input-group-sm col-sm-4 mb-3">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text" id="inputGroupnroci">Nro CI:</span>
                                    </div>
                                    <input type="text" class="form-control text-right" aria-label="Small"
                            ...
                            <div class="form-row">
                                <div class="input-group input-group-sm col-sm-3 mb-3">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text" id="inputGroupTotalpa">Total:</span>
                                    </div>
                                    <input type="text" class="form-control text-right" aria-label="Small"
                                        aria-describedby="inputGroupTotalpa" id="txtTotalp" disabled>
                                </div>
                                ...
                                <div class="input-group input-group-sm col-sm-3 mb-3">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text" id="inputGroupTotalbspaa">Pago BS:</span>
                                    </div>
                                    <input type="text" class="form-control text-right" aria-label="Small"
                                ...
                                <div class="input-group input-group-sm col-sm-3 mb-3">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text" id="inputGroupTotaldolar">Pago USD:</span>
                                    </div>
                                    <input type="text" class="form-control text-right" aria-label="Small"
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <table id="tbDetallePag" class="table table-sm table-striped">
                                        <thead>
                                            <tr>
                                                <th>Producto</th>
                                                <th>Cantidad</th>
...
<asp:Content ID="Content3" ContentPlaceHolderID="footer" runat="server">
    <script src="jsfro/ListaPagaduria.js" type="text/javascript"></script>
</asp:Content>
